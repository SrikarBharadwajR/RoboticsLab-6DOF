...
def main():
    ...
    urdf_file_path = "/mnt/Storage/Documents/MIT/Books/Robotics-2_Lab/Mini_Project/src/conveyorbelt_gazebo/urdf/box.urdf"  # It is assumed that the .urdf/.xacro file is located in /urdf folder!
